...
ROOT_URLCONF = 'taskmanagement.urls'  # Adjust to your project name
...
urlpatterns = [
    ...
    path('', include('tasks.urls')),  # Include your app URLs
]
```
...
CREATE USER 'taskuser'@'localhost' IDENTIFIED BY 'your_password_here';
